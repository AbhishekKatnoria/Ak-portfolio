...
const Footer = () => {
  ...
  const titleChars = "ABHISHEK.".split("");

  const Social = [
    { name: 'LinkedIn', url: 'https://linkedin.com/in/abhishek-katnoria-2221581b2' },
    { name: 'GitHub', url: 'https://github.com/AbhishekKatnoria' }
  ]
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-white/30 text-sm">
            © {new Date().getFullYear()} Abhishek Katnoria. All Rights Reserved.
          </p>
