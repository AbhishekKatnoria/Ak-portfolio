...
const Contact = () => {
  ...
  {
    icon: faGithub,
    link: "https://github.com/AbhishekKatnoria",
  },
  {
    icon: faLinkedin,
    link: "https://linkedin.com/in/abhishek-katnoria-2221581b2",
  },
];
        ...
        <div className="grid md:grid-cols-2 gap-20 items-start">
          ...
          <div>
            ...
            <div className="space-y-8">
              <div
                onClick={() => copyToClipboard('abhishekkatnoria993@gmail.com')}
              ...
              >
                ...
                <div className="flex flex-col">
                  <span className="text-xl font-light leading-none mb-2">abhishekkatnoria993@gmail.com</span>
                  ...
                  <div key={field} className="relative group">
                    ...
                    <div className="relative">
                      <input
                        ...
                        placeholder={field === 'name' ? 'Abhishek Katnoria' : field === 'email' ? 'abhishek@example.com' : 'Project Inquiry'}
                      />
