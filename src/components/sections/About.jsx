...
import profileImg from "../../assets/abhishek.png";
              ...
              <Magnetic strength={0.2}>
                <div className="relative rounded-3xl overflow-hidden border border-white/10 group h-full cursor-none">
                  ...
                  <div className="absolute bottom-6 left-6">
                    <h3 className="text-3xl font-bold text-white mb-1">Abhishek Katnoria</h3>
                    <p className="text-white/60 font-mono text-sm">Software Engineer</p>
            ...
            <Tilt className="h-full">
              <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-3xl p-8 flex flex-col justify-center h-full hover:bg-white/10 transition-colors duration-300">
                ...
                <p className="text-white/70 leading-relaxed font-light text-lg">
                  Software Engineer focused on building responsive, performant
                  cross-platform applications with modern frontend engineering.
                  Experienced with <b className="text-white">React</b>,{" "}
                  <b className="text-white">TypeScript</b>,{" "}
                  <b className="text-white">Next.js</b>, and styling tools like Tailwind
                  CSS, SCSS, and MUI for creating production-grade digital products.
                  Passionate about clean UI architecture, dynamic forms, and engineering
                  applications that feel fast, intuitive, and polished across every device.
                </p>
              </div>
            </Tilt>
          </motion.div>
          ...
          >
            <Tilt className="h-full">
              <div className="bg-[#1a1a1a] border border-white/10 rounded-3xl p-6 flex flex-col items-center justify-center h-full relative overflow-hidden group">
                ...
                <span className="text-5xl font-bold text-white mb-2 relative z-10">1.5+</span>
