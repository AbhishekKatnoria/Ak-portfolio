...
import smol from '../../assets/hiretechies.png'
import pupapers from '../../assets/shopix.png'
import travel from '../../assets/nft.png'
  ...
  const projectData = [
    {
      image: smol,
      title: 'HireTechies',
      description: 'Developed dashboards and recruitment workflows for a hiring platform. Built candidate management, resume screening, and interview scheduling features, integrating REST APIs with RTK Query for efficient data fetching and state management.',
    ...
    },
    {
      image: pupapers,
      title: 'ShopBix',
      description: 'Developed business listing and category-based marketplace modules with detailed business profile pages. Built Create Business, My Business, Business Profile, Business Approval, and KYC Verification workflows with responsive onboarding forms.',
      tech: ['React.js', 'JavaScript', 'REST APIs'],
      link: 'https://www.shopbix.com',
      accentColor: '#10b981', // Emerald
    },
    {
      image: travel,
      title: 'NFT Marketplace',
      description: 'Developed the user interface for a dynamic NFT marketplace with responsive design and interactive features, including like/dislike functionality to boost engagement, with a strong focus on performance and fast load times.',
      tech: ['React', 'Tailwind CSS', 'TypeScript'],
      link: 'https://nft-three-peach.vercel.app',
