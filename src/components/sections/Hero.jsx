  ...
  return (
    ...
    >
      ...
      <div className="text-center px-6 z-10 relative">
        ...
        >
          Building responsive, performant React applications with clean UI architecture.
          Where code meets craftsmanship, and ideas transform into reality.
        </motion.p>
