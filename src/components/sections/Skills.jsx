...
import {
  faReact, faHtml5, faCss3Alt, faJs, faSass
} from '@fortawesome/free-brands-svg-icons';
import { faCode, faLayerGroup, faCubes, faPaintBrush } from '@fortawesome/free-solid-svg-icons';

const Skills = () => {
  // Skills Data with 3D coordinates (x, y: %, z: depth factor)
  const skills = useMemo(() => [
    { name: "React", icon: faReact, x: 20, y: 30, z: 20, color: "#61DAFB" },
    { name: "TypeScript", icon: faCode, x: 75, y: 25, z: 10, color: "#3178C6" },
    ...
    { name: "Sass", icon: faSass, x: 60, y: 60, z: 5, color: "#CC6699" },
    { name: "Tailwind", icon: faPaintBrush, x: 30, y: 80, z: 10, color: "#06B6D4" },
    { name: "MUI", icon: faCubes, x: 50, y: 15, z: 25, color: "#007FFF" },
    { name: "Redux", icon: faLayerGroup, x: 80, y: 45, z: 15, color: "#764ABC" },
    { name: "Next.js", icon: faLayerGroup, x: 35, y: 35, z: 0, color: "#ffffff" },
    { name: "RTK Query", icon: faCode, x: 65, y: 85, z: 20, color: "#764ABC" }
  ], []);
